...
@endsection
@section('script')
<script src="{{ URL::to('/')}}/public/assets2/js/core/jquery.min.js"></script>
<script src="{{ URL::to('/')}}/public/assets2/js/core/popper.min.js"></script>
<script src="{{ URL::to('/')}}/public/assets2/js/core/bootstrap.min.js"></script>
<script src="{{ URL::to('/')}}/public/assets2/js/core/jquery.slimscroll.min.js"></script>
<script src="{{ URL::to('/')}}/public/assets2/js/core/jquery.scrollLock.min.js"></script>
<script src="{{ URL::to('/')}}/public/assets2/js/core/jquery.appear.min.js"></script>
<script src="{{ URL::to('/')}}/public/assets2/js/core/jquery.countTo.min.js"></script>
<script src="{{ URL::to('/')}}/public/assets2/js/core/js.cookie.min.js"></script>
<script src="{{ URL::to('/')}}/public/assets2/js/codebase.js"></script>
<script src="{{ URL::to('/')}}/public/assets2/js/slick.js"></script>
<script>
...
<script>
	 $('.border_bott').on('click',function(){
		 //$(a).removeClass('.orange1');
		 $('.border_bott a').removeClass('orange1');
		 $(this).children().addClass('orange1');
	 });
</script>
...
<script>
	...
	stop: function(i) {
			$.ajax({
			type: "GET",
			url: "{{ URL::to('/')}}/cv_section_order/{{ Request::segment(2) }}",
