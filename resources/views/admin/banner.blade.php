...
<div style="height:40px; overflow:hidden;">{{ $data->description}}</div>
             ...
             <td  ><a href="{{ url('edit-banner/'.$data->id)}}" class="btn btn-success" style=" float:left">Edit</a>
              <form action="{{ url('delete-banner/'.$data->id)}}" method="post" style="float: left; margin: 0 0 0 10px;">
                {{ csrf_field()}}
                {{ method_field('delete')}}
