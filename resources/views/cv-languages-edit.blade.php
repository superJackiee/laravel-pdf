          ...
          <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div>
                      <div class="card-body">
                            <form action="{{ URL::to('/')}}/edit-languages/{{$cv->id}}" method="post" novalidate="novalidate">
                              {{ csrf_field()}}
                              {{ method_field('PUT')}}
                              <div class="form-group">
                                  <label class="control-label mb-1">Language Name</label>
...
$(document).ready(function(){
    ...
    $('input:radio').change(
      function(){
        ...
        jQuery.ajax({
            type: 'POST',
            url: '{{ URL::to('/')}}/autoupdate-languages-ajax/' + id,
            data: {
              rating: $('#rating').val(),
              _token: '{{csrf_token()}}'
            },
